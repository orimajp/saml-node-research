...
import { Profile, SamlConfig, Strategy, VerifyWithoutRequest } from 'passport-saml';
import fs from 'fs';
...
router.post('/login/callback', authModule, (req, res) => {
  ...
  if ((req as any).session) {
    console.log('login/callback sucess.')
    console.log(JSON.stringify((req as any).session))
